!function(e, t) {
    ...
    function m(e, t) {
        ...
        "" === r.style.display && $e(r) && (i[o] = y(r))) : "none" !== n && (i[o] = "none", 
        Fe.set(r, "display", n)));
    ...
    function b(e, t, n, r, i) {
        ...
        a = v(f.appendChild(o), "script"), l && x(a), n) for (c = 0; o = a[c++]; ) Ue.test(o.type || "") && n.push(o);
        return f;
    }
    function w() {
        return !0;
    ...
    function A(e, t, r, i) {
        ...
        a || i)) {
            for (u = (s = he.map(v(o, "script"), S)).length; f < p; f++) l = o, f !== d && (l = he.clone(l, !0, !0), 
            u && he.merge(s, v(l, "script"))), r.call(e[f], l, f);
    ...
    function q(e, t, n) {
        for (var r, i = t ? he.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || he.cleanData(v(r)), 
        r.parentNode && (n && he.contains(r.ownerDocument, r) && x(v(r, "script")), r.parentNode.removeChild(r));
        return e;
    }
    function L(e, t, n) {
    ...
    function M(e, t, n) {
        ...
        "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]), (o = parseFloat(o) || 0) + R(e, t, n || (a ? "border" : "content"), r, i) + "px");
    }
    ...
    var ee = [], te = e.document, ne = Object.getPrototypeOf, re = ee.slice, ie = ee.concat, oe = ee.push, ae = ee.indexOf, se = {}, ue = se.toString, le = se.hasOwnProperty, ce = le.toString, fe = ce.call(Object), pe = {}, de = "3.2.1", he = function(e, t) {
        return new he.fn.init(e, t);
    }, ge = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ye = /^-ms-/, me = /-([a-z])/g, ve = function(e, t) {
    ...
    he.fn = he.prototype = {
        ...
        r = e[t], a !== r && (l && r && (he.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, 
    ...
    var xe = function(e) {
            ...
            if (!r && ((t ? t.ownerDocument || t : I) !== q && A(t), t = t || q, H)) {
                ...
                if (b.qsa && !z[e + " "] && (!F || !F.test(e))) {
                    if (1 !== h) d = t, p = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        ...
                        p = c.join(","), d = ye.test(e) && l(t.parentNode) || t;
                    }
                    if (p) try {
        ...
        function y(e, t, n, i, o, a) {
            return i && !i[M] && (i = y(i)), o && !o[M] && (o = y(o, a)), r(function(r, a, s, u) {
                var l, c, f, p = [], d = [], y = a.length, m = r || h(t || "*", s.nodeType ? [ s ] : s, []), v = !e || !r && t ? m : g(m, p, e, s, u), x = n ? o || (r ? e : y || i) ? [] : a : v;
                if (n && n(v, x, s, u), i) for (l = g(x, d), i(l, [], s, u), c = l.length; c--; ) (f = l[c]) && (x[d[c]] = !(v[d[c]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
                ...
                } else x = g(x === a ? x.splice(y, x.length) : x), o ? o(null, a, x, u) : Q.apply(a, x);
            });
        }
        function m(e) {
        ...
        function v(e, n) {
            var i = n.length > 0, o = e.length > 0, a = function(r, a, s, u, l) {
                var c, f, p, d = 0, h = "0", y = r && [], m = [], v = N, x = r || o && w.find.TAG("*", l), b = W += null == v ? 1 : Math.random() || .1, T = x.length;
                for (l && (N = a === q || a || l); h !== T && null != (c = x[h]); h++) {
                    ...
                    i && ((c = !p && c) && d--, r && y.push(c));
                }
                if (d += h, i && h !== d) {
                    for (f = 0; p = n[f++]; ) p(y, m, a, s);
                    if (r) {
                        if (d > 0) for (;h--; ) y[h] || m[h] || (m[h] = G.call(u));
                        m = g(m);
                    }
        ...
        }, pe = /^(?:input|select|textarea|button)$/i, de = /^h\d$/i, he = /^[^{]+\{\s*\[native \w/, ge = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, me = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)", "ig"), ve = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        b = t.support = {}, C = t.isXML = function(e) {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(me, ve), e[3] = (e[3] || e[4] || e[5] || "").replace(me, ve), 
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        var l, c, f, p, d, h, g = o !== a ? "nextSibling" : "previousSibling", y = t.parentNode, m = s && t.nodeName.toLowerCase(), v = !u && !s, x = !1;
                        if (y) {
                            if (o) {
                                for (;g; ) {
                            ...
                            if (h = [ a ? y.firstChild : y.lastChild ], a && v) {
                                for (x = (d = (l = (c = (f = (p = y)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === W && l[1]) && l[2], 
                                p = d && y.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop(); ) if (1 === p.nodeType && ++x && p === t) {
                                    c[e] = [ W, d, x ];
                                    break;
                                }
                            } else if (v && (p = t, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), 
                            l = c[e] || [], d = l[0] === W && l[1], x = d), !1 === x) for (;(p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (v && (f = p[M] || (p[M] = {}), 
            ...
            pseudos: {
                ...
                lang: r(function(e) {
                    return ce.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(me, ve).toLowerCase(), 
                    function(t) {
                        var n;
                        do {
        ...
        return c.prototype = w.filters = w.pseudos, w.setFilters = new c(), k = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === p.length) {
                if ((o = p[0] = p[0].slice(0)).length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && H && w.relative[o[1].type]) {
                    if (!(t = (w.find.ID(a.matches[0].replace(me, ve), t) || [])[0])) return n;
                    c && (t = t.parentNode), e = e.slice(o.shift().value.length);
                }
                for (i = fe.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !w.relative[s = a.type]); ) if ((u = w.find[s]) && (r = u(a.matches[0].replace(me, ve), ye.test(o[0].type) && l(t.parentNode) || t))) {
                    if (o.splice(i, 1), !(e = r.length && f(o))) return Q.apply(n, r), n;
                    break;
                }
            }
            return (c || E(e, p))(r, t, !H, n, !t || ye.test(e) && l(t.parentNode) || t), n;
    ...
    }), he.ready.then = qe.then, "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(he.ready) : (te.addEventListener("DOMContentLoaded", f), 
    ...
    he.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, g, y = Fe.get(e);
            if (y) for (n.handler && (o = n, n = o.handler, i = o.selector), i && he.find.matchesSelector(Ye, i), 
            n.guid || (n.guid = he.guid++), (u = y.events) || (u = y.events = {}), (a = y.handle) || (a = y.handle = function(t) {
        ...
        remove: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, g, y = Fe.hasData(e) && Fe.get(e);
            if (y && (u = y.events)) {
                ...
                d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
                    ...
                    a && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, y.handle) || he.removeEvent(e, d, y.handle), 
                    delete u[d]);
    ...
    he.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || he.isXMLDoc(e))) for (a = v(s), 
            o = v(e), r = 0, i = o.length; r < i; r++) j(o[r], a[r]);
            if (t) if (n) for (o = o || v(e), a = a || v(s), r = 0, i = o.length; r < i; r++) D(o[r], a[r]); else D(e, s);
            return (a = v(s, "script")).length > 0 && x(a, !u && v(e, "script")), s;
        },
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (he.cleanData(v(e, !1)), 
            e.textContent = "");
            return this;
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return Le(this, function(e) {
                ...
                if ("string" == typeof e && !et.test(e) && !Ve[(Xe.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                    ...
                    try {
                        for (;n < r; n++) 1 === (t = this[n] || {}).nodeType && (he.cleanData(v(t, !1)), 
                        t.innerHTML = e);
                        t = 0;
                    } catch (e) {}
                }
    ...
    he.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return u || (t = O(s)), a = he.cssHooks[t] || he.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t] : ("string" === (o = typeof n) && (i = Ie.exec(n)) && i[1] && (n = g(e, t, i), 
    ...
    he.Animation = he.extend(X, {
        ...
        prefilters: [ function(e, t, n) {
            var r, i, o, a, s, u, l, c, f = "width" in t || "height" in t, p = this, d = {}, h = e.style, g = e.nodeType && $e(e), y = Fe.get(e, "fxshow");
            ...
            if ((u = !he.isEmptyObject(t)) || !he.isEmptyObject(d)) {
                ...
                null == (l = y && y.display) && (l = Fe.get(e, "display")), "none" === (c = he.css(e, "display")) && (l ? c = l : (m([ e ], !0), 
                ...
                for (r in d) u || (y ? "hidden" in y && (g = y.hidden) : y = Fe.access(e, "fxshow", {
                    display: l
                }), o && (y.hidden = !g), g && m([ e ], !0), p.done(function() {
                    g || m([ e ]), Fe.remove(e, "fxshow");
                    for (r in d) he.style(e, r, d[r]);
                })), u = _(g ? y[r] : 0, r, p), r in y || (y[r] = u.start, g && (u.end = u.start, 
                u.start = 0));
            }
        } ],
    ...
    he.fn.extend({
        ...
        addClass: function(e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(je) || []; n = this[u++]; ) if (i = V(n), 
            r = 1 === n.nodeType && " " + U(i) + " ") {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : he.isFunction(e) ? this.each(function(n) {
                ...
                var t, r, i, o;
                if ("string" === n) for (r = 0, i = he(this), o = e.match(je) || []; t = o[r++]; ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = V(this)) && Fe.set(this, "__className__", t), 
    ...
    he.extend(he.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !Tt.test(d + he.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), 
    ...
    Wt.href = Ct.href, he.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                ...
                l = t >= 200 && t < 300 || 304 === t, r && (b = K(h, C, r)), b = Z(h, b, C, l), 
                ...
                C.statusCode(x), x = void 0, f && y.trigger(l ? "ajaxSuccess" : "ajaxError", [ C, h, l ? p : d ]), 
                v.fireWith(g, [ C, T ]), f && (y.trigger("ajaxComplete", [ C, h ]), --he.active || he.event.trigger("ajaxStop")));
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var i, o, a, s, u, l, c, f, p, d, h = he.ajaxSetup({}, n), g = h.context || h, y = h.context && (g.nodeType || g.jquery) ? he(g) : he.event, m = he.Deferred(), v = he.Callbacks("once memory"), x = h.statusCode || {}, b = {}, w = {}, T = "canceled", C = {
                readyState: 0,
            ...
            if (T = "abort", v.add(h.complete), C.done(h.success), C.fail(h.error), i = Q(Mt, h, n, C)) {
    ...
    he.ajaxSetup({
        ...
        i = Ce.exec(e), o = !n && [], i ? [ t.createElement(i[1]) ] : (i = b([ e ], t, o), 
    ...
    e.fn.grtyoutube = function(t) {
        return this.each(function() {
            var n = e(this).attr("youtubeid"), r = e.extend({
                videoID: n,
                autoPlay: !0,
                theme: "dark"
            }, t);
            !0 === r.autoPlay ? r.autoPlay = 1 : !1 === r.autoPlay && (r.autoPlay = 0), "dark" === r.theme ? r.theme = "grtyoutube-dark-theme" : "light" === r.theme && (r.theme = "grtyoutube-light-theme"), 
            n && e(this).on("click", function() {
                e("body").append('<div class="grtyoutube-popup ' + r.theme + '"><div class="grtyoutube-popup-content"><span class="grtyoutube-popup-close"></span><iframe class="grtyoutube-iframe" src="https://www.youtube.com/embed/' + r.videoID + "?rel=0&wmode=transparent&autoplay=" + r.autoPlay + '&iv_load_policy=3" allowfullscreen frameborder="0"></iframe></div></div>');
