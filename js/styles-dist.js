!function(e, t) {
    ...
    function N(e, t, i, r) {
        ...
        s || r)) {
            for (l = (a = he.map(y(o, "script"), k)).length; p < d; p++) u = o, p !== f && (u = he.clone(u, !0, !0), 
    ...
    var be = function(e) {
        ...
        var b, x, w, E, T, C, F, k, A, S, D, N, L, j, q, M, z, I, R, H = "sizzle" + 1 * new Date(), P = e.document, O = 0, _ = 0, W = n(), U = n(), B = n(), $ = function(e, t) {
            return e === t && (D = !0), 0;
        ...
        return c.prototype = w.filters = w.pseudos, w.setFilters = new c(), C = t.tokenize = function(e, n) {
            ...
            return (c || F(e, d))(i, t, !q, n, !t || ge.test(e) && u(t.parentNode) || t), n;
    ...
    var Tt = e.location, Ct = he.now(), Ft = /\?/;
    ...
    Ot.href = Tt.href, he.extend({
        ...
        ajax: function(t, n) {
            ...
            h.data && (o += (Ft.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(jt, "$1"), 
            f = (Ft.test(o) ? "&" : "?") + "_=" + Ct++ + f), h.url = o + f), h.ifModified && (he.lastModified[o] && T.setRequestHeader("If-Modified-Since", he.lastModified[o]), 
    ...
    he.ajaxSetup({
        ...
        a ? t[a] = t[a].replace(Bt, "$1" + r) : !1 !== t.jsonp && (t.url += (Ft.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), 
    ...
    a = function() {}, t = function() {
        ...
        i.prototype.defaultOptions = {
            ...
            var t, n, s, a, l, u, c, p, d, f, h, m, g, v, y, b, x, w, E, T, C, F, k, A, S, D, N, L, j, q, M, z, I, R, H, P;
            for (P = new XMLHttpRequest(), g = 0, x = e.length; g < x; g++) (s = e[g]).xhr = P;
            F = o(this.options.method, e), R = o(this.options.url, e), P.open(F, R, !0), P.timeout = o(this.options.timeout, e), 
            ...
            for (t = 0, z = [], d = k = 0, q = e.length - 1; 0 <= q ? k <= q : k >= q; d = 0 <= q ? ++k : --k) n = function(n) {
